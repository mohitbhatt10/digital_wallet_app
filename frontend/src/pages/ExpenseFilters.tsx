                    ...
                    <div className="space-y-3">
                      {expenses.map((expense, idx) => {
                        ...
                        return (
                          <div
                            key={expense.id}
                            className="group relative px-5 py-4 flex items-start gap-4 rounded-2xl border border-zinc-200/60 bg-white/70 backdrop-blur-sm hover:shadow-md transition-all"
                          >
                            <div
                              ...
                              <div className="flex items-start justify-between gap-4">
                                <div className="min-w-0">
                                  <div className="flex items-center gap-2">
                                    <span
                                      className="font-semibold text-zinc-800 text-sm truncate max-w-[180px]"
                                      title={
                                        expense.description ||
                                  ...
                                  <div
                                    className="text-xs text-zinc-500 mt-0.5 truncate max-w-[260px]"
                                  ...
                                  {expense.tags && expense.tags.length > 0 && (
                                    <div className="mt-2 flex flex-wrap gap-1.5">
                                      {expense.tags.slice(0, 5).map((tag) => (
                                        <span
                                          key={tag.id}
                                ...
                                <div className="flex flex-col items-end gap-1 shrink-0">
                                  <div className="flex items-center gap-1.5 text-[10px] font-medium text-zinc-500">
                                    <span className="px-2 py-0.5 rounded-md bg-white border border-zinc-200 shadow-sm flex items-center gap-1">
                                      ...
                                      {formatLocalDate(expense.transactionDate)}
                                    </span>
                                    <span className="px-2 py-0.5 rounded-md bg-white border border-zinc-200 shadow-sm flex items-center gap-1">
                                      <svg
                                      ...
                                      {formatLocalTime(expense.transactionDate)}
                                    </span>
                                  </div>
